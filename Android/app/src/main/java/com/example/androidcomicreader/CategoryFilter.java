...
public class CategoryFilter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                fetchCategory(); // load all categories from server
            }
        });
        ...
        compositeDisposable.add(iComicAPI.getSearchedComic(search)
                ...
                .subscribe(new Consumer<List<Comic>>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        ...
                        Toast.makeText(CategoryFilter.this, "No Comics Found", Toast.LENGTH_SHORT).show();
    ...
    private void fetchCategory() {
        ...
        compositeDisposable.add(iComicAPI.getCategoryList()
                ...
                .subscribe(new Consumer<List<Category>>() {
                    ...
                    @Override
                    public void accept(Throwable throwable) throws Exception {
                        Toast.makeText(CategoryFilter.this, "Loading Categories Error", Toast.LENGTH_SHORT).show();
                    }
                }));
