    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Common.chapter_index == 0)  // first chapter
                {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Common.chapter_index == Common.chapterList.size() - 1)  // first chapter
                {
        ...
        compositeDisposable.add(iComicAPI.getImageList(id)
                ...
                .subscribe(new Consumer<List<Link>>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        Toast.makeText(ViewDetail.this, "This chapter is being translated", Toast.LENGTH_LONG).show();
                        dialog.dismiss();
